...
namespace Kolejki_LAB1
{
    public class CarWash
    {
        ...
        public static int NumberOfSucceed = 0;

        private string ShowLog = "N"; 

        public Car CurrentCar = null;
        public static  Queue<Car> CarQueue = new Queue<Car>(); 
        public static Queue<int> CarWaitingTime = new Queue<int>();
        ...
        public void NewCarArrival(Car newCar)
        {
            ...
            if (ShowLog.Equals("T"))
            {
                ...
                ShowCarQueue();
                Console.WriteLine("Czas obsługi: " + newCar.PlannedWaitingTime);
            }
        }

        public void ProcessProgressCurrentCar(int time, Car newCar)
        {
            if (CurrentCar != null)
            {
        ...
        public static void ProcessProgressCarQueue(Car newCar)
        {
